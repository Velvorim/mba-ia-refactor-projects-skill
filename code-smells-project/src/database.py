...
def get_db():
    """Retorna conexao singleton com o banco SQLite.
    PT-01: caminho do banco via variavel de ambiente DATABASE_PATH.
    """
...
def _init_schema(conn):
    ...
    if cursor.fetchone()[0] == 0:
        ...
        # AP-07: senhas hasheadas no seed
        def _hash(s):
            return hashlib.sha256(s.encode()).hexdigest()

        usuarios = [
            ("Admin", "admin@loja.com", _hash("admin123"), "admin"),
            ("Joao Silva", "joao@email.com", _hash("123456"), "cliente"),
